...
function newSelection(BUCODE, reselect) {
    ...
    function addAreaStatistics() {
        ...
        $("#selectionPannel .areaStatistics").append('<div> Vrijstaande woning: <span class="floatRight">' + Math.round((Number(data.buurt[10]) / sumTypeWoningen) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div> 2-onder-1-kap: <span class="floatRight">' + Math.round((Number(data.buurt[11]) / sumTypeWoningen) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div> Rijwoning: <span class="floatRight">' + Math.round((Number(data.buurt[12]) / sumTypeWoningen) * 100) + '%</span></div>')
        ...
        $("#selectionPannel .areaStatistics").append('<div> Koopwoning: <span class="floatRight">' + Math.round((Number(data.buurt[15]) / sumEigendomssituatie) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div> Particuliere huurwoning: <span class="floatRight">' + Math.round((Number(data.buurt[17]) / sumEigendomssituatie) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div class="paddingBottomExtra"> Sociale huurwoning: <span class="floatRight">' + Math.round((Number(data.buurt[16]) / sumEigendomssituatie) * 100) + '%</span></div>')

        $("#selectionPannel .areaStatistics").append('<div> <b>Huishoudengrootte</b> </div>')
        $("#selectionPannel .areaStatistics").append('<div> 1 persoonshuishouden: <span class="floatRight">' + Math.round((Number(data.buurt[18]) / sumHuishoudengrootte) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div> 2 persoonshuishouden: <span class="floatRight">' + Math.round((Number(data.buurt[19]) / sumHuishoudengrootte) * 100) + '%</span></div>')
        $("#selectionPannel .areaStatistics").append('<div class="paddingBottomExtra"> 3+ persoonshuishouden: <span class="floatRight">' + Math.round((Number(data.buurt[20]) / sumHuishoudengrootte) * 100) + '%</span></div>')
